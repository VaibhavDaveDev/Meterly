...
- When dealing with uploads or complex multi-step processes, expand rollback try/catch blocks carefully (as done in `uploads.ts` for file integrity checks).
- Provide unit tests for all route guards, lib logic, and controllers.
