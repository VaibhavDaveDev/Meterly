...
export const properties = sqliteTable(
  "properties",
  {
    ...
    paymentTrackingEnabled: integer("payment_tracking_enabled", {
      mode: "boolean",
    }).default(true),
    readingsRequireApproval: integer("readings_require_approval", {
      mode: "boolean",
    }).default(false),
  ...
  (table) => [index("idx_properties_owner").on(table.ownerId)]
);
