...
const GoogleSVG = () => (
  <svg width="18" height="18" viewBox="0 0 18 18">
    ...
    ></path>
    <path
      d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0 5.482 0 2.443 2.048.957 4.962l3.007 2.332C4.672 5.164 6.656 3.58 9 3.58z"
      fill="#EA4335"
    ></path>
  </svg>
);
...
export function LoginForm({ turnstileSiteKey }: { turnstileSiteKey?: string }) {
  ...
  return (
    <AuthFormLayout
      ...
      description="Access your properties and bills"
      message={message}
      isError={isError}
      isLoading={isLoading}
      socialProviders={[
        ...
        <PasswordInput
          ...
          rightLabel={
            <a
              ...
              className="text-sm font-medium text-primary hover:opacity-80 dark:hover:text-primary-fixed transition-all duration-200 ease-smooth"
            >
              Forgot password?
            </a>
          }
