    ...
    return (
      <div className="text-center py-12">
        <p className="text-muted-foreground">
          No confirmed periods found for this tenancy.
        </p>
        <Button
          variant="outline"
          className="mt-4"
        ...
        <div className="rounded-xl border border-border bg-surface p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 min-h-[100px]"
