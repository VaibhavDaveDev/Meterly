...
export function UploadedPhotos({
  ...
  // use custom ConfirmDialog and useToast to replace native alert/confirm dialogs
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
        {photos.map((photo) => (
          <div key={photo.id} className="relative group">
            ...
            {/* keep overlay action buttons always visible on mobile devices (no hover state) */}
