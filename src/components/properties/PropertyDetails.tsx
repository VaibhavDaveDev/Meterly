      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-2.5 mb-1">
            ...
            <Badge variant={isOwner ? "owner" : "tenant"}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleInvite}>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Send an email invitation. They will be prompted to create
                      an account or log in to access this property&apos;s bills.
                    </DialogDescription>
                  </DialogHeader>
          ...
          >
            ...
            {isOwner && pendingEditRequestCount > 0 && (
              <span className="ml-1 inline-flex items-center justify-center w-4 h-4 text-[10px] font-bold rounded-full bg-amber-500 text-white">
                {pendingEditRequestCount > 9 ? "9+" : pendingEditRequestCount}
              </span>
            )}
          </button>
          {isOwner && (
