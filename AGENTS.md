...
- **Error Boundaries:** Every Astro page with a React `client:load` island component must wrap its top-level component export using the `withErrorBoundary` HOC to ensure render errors show a fallback UI instead of crashing the island silently.
